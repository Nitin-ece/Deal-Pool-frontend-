...
export function StatusBadge({
  ...
  switch (status) {
    ...
    case "offer_accepted":
      return <span className={cn(base, "bg-[var(--ink)] text-[var(--paper)] font-extrabold")}>Matched</span>;
    case "completed":
      return (
    ...
    case "active":
      return <span className={cn(base, "bg-[var(--ink)] text-[var(--paper)] font-extrabold")}>In use</span>;
    case "returned":
