        ...
        {CATEGORIES.map((cat) => {
          ...
          return (
            <button
              ...
              className={`inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full text-xs font-semibold whitespace-nowrap transition-all duration-150 cursor-pointer ${
                isActive
                  ? "bg-[var(--ink)] text-[var(--paper)] font-bold shadow-xs scale-102"
